...
- Un bot al que nunca le crean usuarios se comporta EXACTO como antes.
...
Cierra con: "Tú sigues entrando igual (admin + tu contraseña). Si un día olvidas la
maestra: `npx wrangler secret put DASHBOARD_PASSWORD` en la carpeta del bot."
