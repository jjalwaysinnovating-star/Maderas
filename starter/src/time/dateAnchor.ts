 ...
 */
export function botTimezone(env: Env): string {
  return env.BOT_TIMEZONE || env.CALCOM_TIMEZONE || "America/Mexico_City";
}
 ...
 */
export function dateAnchorBlock(env: Env, now: Date = new Date()): string {
