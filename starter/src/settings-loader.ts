...
export async function resolveAgentConfig(
  ...
  // Opt-in (default OFF): la Bóveda solo archiva si el dueño la prendió (toggle
  // "1"/"0" como los demás superpoderes) Y es Pro. El binding MEDIA (el R2) lo
  // valida el runtime aparte (bovedaReady).
