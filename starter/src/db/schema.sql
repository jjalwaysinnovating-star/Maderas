...
-- clientes al R2 del miembro (binding MEDIA) para verlos en el panel. Solo se
-- llena si el superpoder está ON y el binding existe. r2_key = la llave en R2;
-- el panel las sirve tras su auth (GET /admin/media/:id), nunca públicas.
