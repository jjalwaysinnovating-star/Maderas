...
describe("bots existentes sin usuarios de panel — nada cambia", () => {
  ...
  it("navegador sin credenciales → 401 Basic (el diálogo nativo de siempre), NO redirect", async () => {
    __resetHayCache();
  ...
  it("solo cuando el bot YA tiene usuarios, el navegador va al login bonito", async () => {
    __resetHayCache();
